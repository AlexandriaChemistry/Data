...
def water_ions_induction():
    ...
    models = { "CHARMM": { "ff": "../ForceFields/CharmmDrude.xml", "mp": mymp },
               "PC+GS": { "ff": "../AlexandriaFF/PS+GS-elec.xml", "mp": mymp } }
